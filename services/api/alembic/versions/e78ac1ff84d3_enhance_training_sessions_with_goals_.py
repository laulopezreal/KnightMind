...
def upgrade() -> None:
    ...
    op.add_column(
        "training_sessions", sa.Column("session_type", sa.String(), nullable=True)
    )
    op.add_column(
        "training_sessions", sa.Column("target_accuracy", sa.Float(), nullable=True)
    )
    op.add_column(
        "training_sessions",
    ...
    op.add_column(
        "training_sessions", sa.Column("session_data", sa.JSON(), nullable=True)
    )
