  ...
  return (
    <div className="space-y-12 animate-teedin">
      <section className="space-y-5 max-w-3xl">
        ...
        <p className="text-lg md:text-xl font-light text-primary/70 leading-relaxed">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <article className="bg-primary/5 border border-primary/10 rounded-sm p-6 space-y-3">
          <p className="text-xs tracking-[0.2em] uppercase text-primary/70 font-sans">Step 1</p>
        ...
        <article className="bg-primary/5 border border-primary/10 rounded-sm p-6 space-y-3">
          <p className="text-xs tracking-[0.2em] uppercase text-primary/70 font-sans">Step 2</p>
        ...
        <article className="bg-primary/5 border border-primary/10 rounded-sm p-6 space-y-3">
          <p className="text-xs tracking-[0.2em] uppercase text-primary/70 font-sans">Step 3</p>
